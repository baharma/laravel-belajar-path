...
@endif
<form class="container" action="{{route('buku.update',$item->id)}}" method="POST">
    @csrf
    @method('PUT')
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleInputPassword1" name="pembuat" value="{{$item->pembuat}}">
      </div>
